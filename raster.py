...
class RasterWriter(object):
    ...
    def open(self, filename):
        ...
        self.prm.write('#</SET>\n\n')
        self.prm.write('# --- Value description --- #\n')
        self.prm.write('# element-nr. [-]\n')
        self.prm.write('# geod. height [m]\n')
        self.prm.write('# material id [-] (must match one of the ids in the materials file)\n')
        self.prm.write('# initial waterlevel [m]\n')
        self.prm.write('# boundary condition [bool] (whether the cell is a boundary)\n')
        self.prm.write('# stationary boundary condition [bool] (whether the boundary is stationary (true) or instationary (false))\n')
        self.prm.write('# boundary condition value [-] (if stationary is true, unit is according to "boundary type", otherwise id of hydrograph)\n')
        self.prm.write('# boundary type [-] (whether the boundary condition value unit is "point" [m3/s], "area" [m3/(s m2)]).\n\n')
        self.prm.write('\n')
