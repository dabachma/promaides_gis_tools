...
class CINPolygonExport(object):
    ...
    def execTool(self):
        ...
        with open(filename, 'w') as polygon_file:
            ...
            index = 0
            polygon_file.write('########################################################################\n')
            polygon_file.write('# This file was automatically generated by "Point Export for ProMaiDes CIN Module"')
            ...
            polygon_file.write('#  Start the CI-points with !BEGIN and end it with !END; in between are:\n')
            ...
            for feature, id, name, sector, enduser in zip(features, ids, names,sectors, endusers):
                ...
                polygon_file.write('{a} {b} {c} {d} {e}\n'.format
                 (a=str(id), b=len(points)-1, c=str(name), d=int(sector), e=int(enduser)))
