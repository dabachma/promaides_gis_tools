...
class PluginDialog(QDialog):
    ...
    def __init__(self, iface, parent=None, flags=Qt.WindowFlags()):
        ...
        self.to_render = [
            ...
            [self.hyd_re_fd_2, "hyd_floodplain_elem_instat_result_prm", "waterlevel", ["HYD","Results"], "FP Instationary Depth [m]"],
            ...
            if layer[0].isChecked() and layer[1] != "" and layer[0].isEnabled():
                ...
                if ColumnType is not None:
                    ...
                    if layer_name == "hyd_river_profile_prm":
                        ...
                        vlayer = self.vlayerMakeradvanced("graduated", QColor(144, 238, 144), QColor(62, 38, 22), 5, project_name, layer_name, ColumnType[0], value_field, layer_toBeNamed)
                        ...
                        vlayer = self.vlayerMakeradvanced("graduated", QColor(255,255,255), QColor(128, 197, 233), 5, project_name, layer_name, ColumnType[0], value_field, layer_toBeNamed)
                    elif layer_name == "hyd_floodplain_elem_instat_result_prm":
                        vlayer = self.vlayerMakeradvanced("graduated", QColor(255,255,255), QColor(128, 197, 233), 5, project_name, layer_name, ColumnType[0], value_field, layer_toBeNamed)
