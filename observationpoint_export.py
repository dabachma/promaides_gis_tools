...
class ObservationPointExport(object):
    ...
    def execTool(self):
        ...
        with open(filename, 'w') as observationpoint_file:
            ...
            observationpoint_file.write('#\n')
            observationpoint_file.write('# Use in .ilm-file (just copy, delete the leading "#", set file(s)):\n')
            observationpoint_file.write('# Set in global section between !$BEGINGLOBAL and !$ENDGLOBAL\n')
            observationpoint_file.write('#  !OBSPOINTFILE = "./PATH2FILE/FILE_NAME.txt"\n')
            observationpoint_file.write('########################################################################\n\n')
