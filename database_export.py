...
class PluginDialog(QDialog):
    ...
    def onConnectionSettingsEdited(self):
        ...
        if host == '' or name == '' or user == '' or pwrd == '':
...
class DatabaseExport(object):
    ...
    def execTool(self):
        ...
        if self.dialog.profiles_box.isChecked():
            self.export_river_profiles(proj_name, cur, folder)
        if self.dialog.floodplain_box.isChecked():
            self.export_floodplains(proj_name, cur, folder)
        if self.dialog.materials_box.isChecked():
            self.export_materials(proj_name, cur, folder)

        QMessageBox.information(self.iface.mainWindow(), "Database Export", "Export finished successfully.")
        self.quitDialog()

    @staticmethod
    def export_river_profiles(proj_name, cursor, folder):
        ...
        for r in cursor.fetchall():
            ...
            with open(filename, 'w') as rvr_file:
                ...
                rvr_file.write("""# This file was automatically generated by ProMaIDes Database Export Plugin.
TITLE = "{}"
...
AUXDATA PoleniFacRight = "{}"
    ...
    @staticmethod
    def export_floodplains(proj_name, cursor, folder):
        ...
        for fpl in cursor.fetchall():
            ...
            with open(filename, 'w') as fpl_file:
                fpl_file.write("""# This file was automatically generated by ProMaIDes Database Export Plugin.
...
!BEGIN\n""".format(fpl[1], fpl[2], fpl[3], fpl[4], fpl[5], fpl[6], fpl[7], fpl[8]))
    ...
    @staticmethod
    def export_materials(proj_name, cursor, folder):
